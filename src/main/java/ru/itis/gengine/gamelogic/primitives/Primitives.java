...
public class Primitives {
    ...
    public static MeshData createRectangler(float height, float width) {
        Vertex[] vertices = {
                // Front
                new Vertex( -width / 2,  -height / 2, 0.f, 0.0f, 1.0f, 1.f), // 0
                new Vertex( width / 2,  -height / 2, 0.f, 1.0f, 1.0f, 1.f),  // 1
                new Vertex( width / 2,  height / 2, 0.f, 1.0f, 0.0f, 1.f),   // 2
                new Vertex( -width / 2,  height / 2, 0.f, 0.0f, 0.0f, 1.f),  // 3
        };
